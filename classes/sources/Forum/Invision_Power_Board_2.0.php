...
/* ------------------------------------------------------------------ */
//	Forum Module: Invision Power Board 2.0.x
//		module version: 1.01
//		forum versions: 2.0.x
//		12/4/2005
/* ------------------------------------------------------------------ */


class EP_Dev_Forum_News_Invision_Power_Board_2_0_Access
{
	var $SMILIES;
	var $POSTS;
	...
	function EP_Dev_Forum_News_Invision_Power_Board_2_0_Access(&$DB_access, &$forum_conf, &$error_handle)
	{
	...
	function parse_Smilies(&$text)
	{
		...
		{
			// +------------------------------
			//	IPB 2 uses a radical smilie setup.
			//
